...
<main id="main" class="main">
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Tambah permen</h5>

                    <!-- Custom Styled Validation with Tooltips -->
                    <form class="row g-3 needs-validation" action="{{ route('permen.store') }}" method="post"
                        ...
                        <div class="col-md-12 position-relative">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control @error('permen') is-invalid @enderror "
                                    name="permen" id="permen" aria-describedby="permenPrepend" value="{{ old('permen') }}">
