                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('permen.create') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i>Tambah Permen</a>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($permen as $itempermen)
                                                   
                                                        <tr>

                                                            <td scope="row">{{ $loop->iteration }}</td>
                                                            <td>
                                                                <a href="{{ route('permen.show', $itempermen->id) }}" class="text-primary fw-bold">{{ $itempermen->permen}}</a>
                                                            </td>
                                                            <td>

                                                                <a href="{{ route('permen.edit', $itempermen->id) }}"
                                                                    class="btn btn-warning btn-sm"><i
                                                                        class="fas fa-edit"></i> Edit</a>
                                                                <a href="{{ route('permen.delete', $itempermen->id) }}"
