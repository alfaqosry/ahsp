...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Daftar jenis pekerjaan {{  $permen->permen }}</h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('jenispekerjaan.create', $permen->id) }}" class="btn btn-primary btn-sm"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($jenispekerjaan as $itemjenispekerjaan)
                                                   
                                                        <tr>

                                                            <td scope="row">{{ $loop->iteration }}</td>
                                                            <td>
                                                                <a href="{{ route('jenispekerjaan.show', $itemjenispekerjaan->id) }}" class="text-primary fw-bold">{{ $itemjenispekerjaan->jenis_pekerjaan}}</a>
                                                            </td>
                                                            <td>

                                                                <a href="{{ route('jenispekerjaan.edit', $itemjenispekerjaan->id) }}"
                                                                    class="btn btn-warning btn-sm"><i
                                                                        class="fas fa-edit"></i> Edit</a>
                                                                <a href="{{ route('jenispekerjaan.delete', $itemjenispekerjaan->id) }}"
