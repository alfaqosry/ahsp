...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Edir {{ $koefisien->koefisien }}</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row">
            <div class="form-group mb-3">
                <a href="{{route('pekerjaan.show', $koefisien->pekerjaan_id)}}" class="btn btn-warning btn-sm"><i class="bi bi-arrow-left-circle"></i>
                    Kembali</a>
            </div>

            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit Koefisien</h5>

                    <!-- Custom Styled Validation with Tooltips -->
                    <form class="row g-3 needs-validation" action="{{ route('koefisien.update', $koefisien->id) }}" method="post"
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <select class="form-select  @error('bahan_id') is-invalid @enderror"
                                            ...
                                            <option selected disabled value="{{$koefisien->bahan_id}}">{{$koefisien->bahan->bahan}}</option>
                                ...
                                <input type="text" class="form-control @error('koefisien') is-invalid @enderror "
                                    name="koefisien" id="koefisien" aria-describedby="koefisienPrepend" value="{{ $koefisien->koefisien }}">
