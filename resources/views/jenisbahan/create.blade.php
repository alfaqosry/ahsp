...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Jenis Bahan</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Tambah Jenis Bahan</h5>

                    <!-- Custom Styled Validation with Tooltips -->
                    <form class="row g-3 needs-validation" action="{{ route('jenisbahan.store') }}" method="post"
                        ...
                        <div class="col-md-12 position-relative">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control @error('jenis_bahan') is-invalid @enderror "
                                    name="jenis_bahan" id="jenis_bahan" aria-describedby="jenis_bahanPrepend" value="{{ old('jenis_bahan') }}">
