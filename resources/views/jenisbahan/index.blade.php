                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('jenisbahan.create') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i>Tambah jenis bahan</a>
                            </div>
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($jenisbahan as $itemjenisbahan)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $itemjenisbahan->jenis_bahan }}</td>
                                                            <td>
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <a href="{{ route('jenisbahan.edit', $itemjenisbahan->id) }}"
                                                                        class="btn btn-warning btn-sm"><i
                                                                            class=" bx bxs-pencil"></i></a>
                                                                    <a href="{{ route('jenisbahan.delete', $itemjenisbahan->id) }}"
