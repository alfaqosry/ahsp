                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('pekerja.create') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i>Tambah Pekerja</a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($pekerja as $itempekerja)
                                                <tr>
                                                    ...
                                                    <td>{{ $itempekerja->kode }}</td>
                                                    <td> {{ $itempekerja->satuan->satuan }}</td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                        <a href="{{ route('pekerja.edit', $itempekerja->id) }}"
                                                            class="btn btn-warning btn-sm"><i class="bx bxs-pencil"></i>
                                                           </a>
                                                        <a href="{{ route('pekerja.delete', $itempekerja->id) }}"
