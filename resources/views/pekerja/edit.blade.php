...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Edit {{$pekerja->pekerja}}</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item">{{$title}}</li>
                <li class="breadcrumb-item active">Edit {{$pekerja->pekerja}}</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit {{$pekerja->pekerja}}</h5>

                    <!-- Custom Styled Validation with Tooltips -->
                    <form class="row g-3 needs-validation" action="{{ route('pekerja.update', $pekerja->id) }}" method="post"
                        ...
                        <div class="col-md-12 position-relative">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control @error('pekerja') is-invalid @enderror "
                                    name="pekerja" id="pekerja" aria-describedby="pekerjaPrepend" value="{{ $pekerja->pekerja }}">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control @error('kode') is-invalid @enderror "
                                    name="kode" id="kode" aria-describedby="kodePrepend" value="{{ $pekerja->kode }}">
                                {{-- <div class="valid-tooltip">
                                    Looks good!
                                </div> --}}
                                @error('kode')
                            ...
                            <div class="row">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <select class="form-select select2 @error('satuan') is-invalid @enderror" id="satuan_id" name="satuan_id">
                                        <option value="{{ $pekerja->satuan->id }}">{{$pekerja->satuan->satuan}}</option>
