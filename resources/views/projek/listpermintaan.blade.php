                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($projek as $itemprojek)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('persetujuan.show', $itemprojek) }}" class="text-primary fw-bold">{{ $itemprojek->projek}}</a></td>
                                                            <td>{{ $itemprojek->tahun }}</td>
                                                            <td>{{ $itemprojek->permen->permen }}</td>
                                                            <td>

                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <a href="{{ route('projek.acc', $itemprojek->id) }}"
                                                                        class="btn btn-success btn-sm"><i
                                                                            class="bx bx-check"></i></a>
                                                                    <a href="{{ route('projek.tolak', $itemprojek->id) }}"
                                                                        class="btn btn-danger btn-sm"
                                                                        onclick="return confirm('Apakah Anda yakin ingin menolak AHSP ini?')"><i
                                                                            class="bx bx-x"></i></a>
                                                                    </div>
                                                            </td>
                                                        </tr>
