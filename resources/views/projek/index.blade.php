                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('projek.create') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i>Tambah Projek</a>
                            </div>
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($projek as $itemprojek)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('projek.show', $itemprojek) }}" class="text-primary fw-bold">{{ $itemprojek->projek}}</a></td>
                                                            <td>{{ $itemprojek->tahun }}</td>
                                                            <td>{{ $itemprojek->permen->permen }}</td>
                                                            <td>

                                                                <a href="{{ route('projek.edit', $itemprojek->id) }}"
                                                                    class="btn btn-warning btn-sm"><i
                                                                        class="fas fa-edit"></i> Edit</a>
                                                                <a href="{{ route('projek.delete', $itemprojek->id) }}"
