                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('satuan.create') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i>Tambah Satuan</a>
                            </div>
                                                ...
                                                @foreach ($satuan as $itemsatuan)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('satuan.edit', $itemsatuan->id) }}"
                                                                    class="btn btn-warning btn-sm"><i
                                                                        class="bx bxs-pencil"></i> </a>
                                                                <a href="{{ route('satuan.delete', $itemsatuan->id) }}"
